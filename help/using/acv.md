...
`ACV` (Validador de contenido de Assets) Identifica los nodos obligatorios que faltan y las infracciones en el contenido del recurso. Estas cosas podrían provocar un error en ciertas funciones de Assets en Experience Manager as a Cloud Service.
...
* `missing.original.rendition`: identifique los archivos con la representación original obligatoria que falta en el repositorio. La vista previa de las páginas del PDF no requiere la generación de subrecursos en AEMaaCS. Por lo tanto, para los recursos de PDF, se suprime la creación de informes de los subrecursos que carecen de la representación original.
...
* Un número elevado de descendientes bajo un nodo de metadatos puede ralentizar la descarga de carpetas que contienen recursos que infringen la directiva.
* AEM La presencia de nodos conflictivos podría provocar un error de ingesta en los as a Cloud Service de la.
