...
* Cambiar o quitar configuraciones puede causar los siguientes problemas:
   ...
   * Los valores de la configuración del externalizador `com.day.cq.commons.impl.ExternalizerImpl` están configuradas por variables de entorno de cloud manager en AEM as a Cloud Service.
